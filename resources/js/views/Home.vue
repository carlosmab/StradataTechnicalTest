    ...
    <div class="h-screen bg-white">
        <div class="flex">
            <div class="pl-6 bg-gray-200 w-64 h-screen border-r-2 border-gray-300">
                <nav class="pt-4">
                    <router-link to="/">
                        <p class="text-blue-500 uppercase font-bold text-lg mt-4">StrData</p>
                    </router-link>

                    <p class="pt-12 text-gray-500 uppercase font-bold text-">menú</p>

                    <router-link to="/coincidencias" class="flex items-center py-2 hover:text-blue-600 text-sm">
                        <svg viewBox="0 0 24 24" class=" fill-current w-5 h-5 mt-2 text-blue-600">
